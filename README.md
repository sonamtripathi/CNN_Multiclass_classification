...
Here we will build a multiclass classification model using a custom convolutional neural network in TensorFlow.
...
Please Note:- This problem statement was the part of IIIT Bangalore PGD in Machine Learning curriculum.
